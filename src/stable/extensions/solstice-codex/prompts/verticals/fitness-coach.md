# Vertical Template Pack: Fitness Coach / Personal Training
...
3. Programs and offer ladder with format, duration, frequency, group size, price anchor or consultation path, and who each option fits.
4. Coach profile with certifications, methodology, specialties, languages, personal story, and real training media.
5. Results and proof using real client stories, measured progress, sourced reviews, and consented before/after media; never fabricate names, numbers, or transformations.
6. Training journey: assessment, baseline, plan, coached sessions, tracking, nutrition boundary, check-ins, and progression review.
7. Schedule and booking path with trial/consultation, WhatsApp, cancellation policy, location, parking, and equipment expectations.
8. FAQ covering fitness level, injuries and medical clearance, pricing, commitment, session format, nutrition scope, and what to bring.
9. Mobile sticky action bar for trial, WhatsApp, or booking.

## Research And Business Inputs

- Before designing, study the strongest relevant fitness-coaching sites named or discovered in the request and record concrete conversion, content, offer, and visual decisions in `DECONSTRUCT.md`.
...
- Fitness supports strong but purposeful motion: scroll-scrub progression, pinned program chapters, kinetic metrics, training-sequence frames, and controlled parallax tied to the coaching narrative.
- Preserve readable pricing, program comparison, booking controls, and reduced-motion behavior.
- Verify real scroll-depth across desktop and mobile. Motion is not complete until the final chapter and CTA are reachable and evidenced.
